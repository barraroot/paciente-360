...
return new class extends Migration
{
    ...
    {
        Schema::create('ai_persona_knowledge_base', function (Blueprint $table): void {
            $table->id();
        ...
        DB::statement(<<<'SQL'
            CREATE UNIQUE INDEX ai_persona_knowledge_base_unique
            ON ai_persona_knowledge_base (ai_persona_id, ai_knowledge_base_id)
        SQL);
    }

    public function down(): void
    {
        Schema::dropIfExists('ai_persona_knowledge_base');
    }
};
