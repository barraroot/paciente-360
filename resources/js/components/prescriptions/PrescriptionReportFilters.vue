...
const activeFilterCount = computed(() => {
  return Object.values(local.value).filter((v) => v !== null && v !== undefined && v !== '').length
})
</script>
  ...
  <div class="space-y-3">
    ...
    <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
      ...
      <div class="relative">
        ...
        <div v-if="patientSearchLoading" class="absolute right-2 top-1/2 -translate-y-1/2 text-xs text-foreground-muted" aria-live="polite" aria-label="Buscando...">
