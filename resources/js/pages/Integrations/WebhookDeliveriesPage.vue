...
<template>
    <section class="page">
        ...
        <div
            ...
            tabindex="0"
            role="region"
            aria-label="Tabela de eventos no DLQ"
        >
            <table class="dlq-table">
                ...
                <tbody>
                    <tr v-for="row in store.deadLetter" :key="row.id">
                        ...
                        <td>
                            <span v-if="row.resent_at" class="badge badge--success"
                                >Sim — {{ row.resent_at }}</span
                            >
        ...
        >
            <p>
                Reenviar o evento <strong>{{ resendTarget?.event_type }}</strong> (ID
                {{ resendTarget?.event_id }})?
            </p>
        </ConfirmModal>
