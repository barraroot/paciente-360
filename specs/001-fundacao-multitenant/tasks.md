...
- [ ] T001 [P] Adicionar dependências PHP no composer.json — `composer.json`
...
- [ ] T002 [P] Adicionar dependências Node no package.json — `package.json`
...
- [ ] T003 Configurar Docker Compose com PostgreSQL 18, Redis 7, Mailpit, Reverb, Horizon worker — `compose.yaml`
...
- [ ] T004 [P] Configurar argon2id como driver default de hash — `config/hashing.php`
...
- [ ] T005 [P] Criar config/tenancy.php — `config/tenancy.php`
...
- [ ] T006 [P] Criar config/billing.php — `config/billing.php`
...
- [ ] T007 [P] Criar config/audit.php — `config/audit.php`
...
- [ ] T008 [P] Configurar pint.json — `pint.json`
...
- [ ] T009 [P] Configurar PHPUnit com cobertura mínima 70% — `phpunit.xml`
...
- [ ] T010 [P] Setup Playwright para E2E — `playwright.config.ts` + `tests/e2e/`
...
- [ ] T011 [P] GitHub Actions CI — `.github/workflows/ci.yml`
...
- [ ] T012 [P] Integrar Sentry com contexto de tenant — `config/sentry.php`, `app/Providers/AppServiceProvider.php`
...
- [ ] T013 [P] Habilitar Telescope só em dev/staging — `app/Providers/TelescopeServiceProvider.php`
...
- [ ] T014 Vue 3 entrypoint, Pinia e Vue Router — `resources/js/app.js`, `resources/js/router/index.js`, `resources/js/stores/`
...
- [ ] T015 [P] Tailwind v4 + tema base — `resources/css/app.css`, `tailwind.config.js`
...
- [ ] T016 SPA shell + rotas web — `resources/views/app.blade.php`, `routes/web.php`
...
- [ ] T017 [P] Laravel Pail integrado em Sail — `compose.yaml`
...
- [ ] T020 [P] Migration `tenants` — `database/migrations/2026_05_10_000001_create_tenants_table.php`
...
- [ ] T021 [P] Migration `plans` — `database/migrations/2026_05_10_000002_create_plans_table.php`
...
- [ ] T022 [P] Migration `subscriptions` — `database/migrations/2026_05_10_000003_create_subscriptions_table.php`
...
- [ ] T023 [P] Migration `subscription_items` — `database/migrations/2026_05_10_000004_create_subscription_items_table.php`
...
- [ ] T024 [P] Migration `users` — `database/migrations/2026_05_10_000005_create_users_table.php`
...
- [ ] T025 [P] Migration `password_reset_tokens` — `database/migrations/2026_05_10_000006_create_password_reset_tokens_table.php`
...
- [ ] T026 [P] Migration `personal_access_tokens` (Sanctum default) — `database/migrations/2026_05_10_000007_create_personal_access_tokens_table.php`
...
- [ ] T027 [P] Migration `sessions` (Laravel default) — `database/migrations/2026_05_10_000008_create_sessions_table.php`
...
- [ ] T028 Migration `permission_tables` (Spatie estendido) — `database/migrations/2026_05_10_000009_create_permission_tables.php`
...
- [ ] T029 [P] Migration `invitations` — `database/migrations/2026_05_10_000010_create_invitations_table.php`
...
- [ ] T030 [P] Migration `professionals` — `database/migrations/2026_05_10_000011_create_professionals_table.php`
...
- [ ] T031 Migration `audit_logs` (com guard de imutabilidade) — `database/migrations/2026_05_10_000012_create_audit_logs_table.php`
...
- [ ] T032 [P] Migration `audit_logs_cold` — `database/migrations/2026_05_10_000013_create_audit_logs_cold_table.php`
...
- [ ] T033 [P] Migration `ai_usage_meters` — `database/migrations/2026_05_10_000014_create_ai_usage_meters_table.php`
...
- [ ] T034 [P] Migration `stripe_events` — `database/migrations/2026_05_10_000015_create_stripe_events_table.php`
...
- [ ] T040 **TEST** Tenant isolation — `tests/Feature/Fase0/Tenant/TenantIsolationTest.php`
...
- [ ] T041 Trait `BelongsToTenant` + `TenantScope` — `app/Models/Concerns/BelongsToTenant.php`, `app/Models/Scopes/TenantScope.php`
...
- [ ] T042 Middleware `ResolveTenant` — `app/Http/Middleware/ResolveTenant.php`
...
- [ ] T043 [P] Middleware `EnsureTenantNotSuspended` — `app/Http/Middleware/EnsureTenantNotSuspended.php`
...
- [ ] T044 [P] Job base `TenantAwareJob` — `app/Jobs/TenantAwareJob.php`
...
- [ ] T045 [P] Redis cache prefix por tenant — `app/Providers/AppServiceProvider.php` ou cache provider custom
...
- [ ] T046 [P] Channel auth `routes/channels.php` por tenant — `routes/channels.php`
...
- [ ] T050 Configurar Sanctum SPA — `config/sanctum.php`, `.env.example`
...
- [ ] T051 Configurar rate limiters — `app/Providers/RouteServiceProvider.php`
...
- [ ] T052 Middleware `LogStructuredRequestData` — `app/Http/Middleware/LogStructuredRequestData.php`
...
- [ ] T060 [P] **TEST** Roles isoladas por tenant — `tests/Feature/Fase0/Tenant/RoleIsolationTest.php`
...
- [ ] T061 [P] Configurar Spatie permission — `config/permission.php`
...
- [ ] T062 Seeder de roles default — `database/seeders/DatabaseSeeder.php` (parte 1)
...
- [ ] T063 Seeder de planos default — `database/seeders/DatabaseSeeder.php` (parte 2)
...
- [ ] T064 Seeder Super Admin inicial — `database/seeders/DatabaseSeeder.php` (parte 3)
...
- [ ] T065 [P] DevSeeder com 2 tenants exemplo — `database/seeders/DevSeeder.php`
...
- [ ] T066 [P] DemoSeeder vazio (placeholder) — `database/seeders/DemoSeeder.php`
...
- [ ] T070 [P] **TEST** AuditLog imutável — `tests/Feature/Fase0/Audit/AuditLogImmutabilityTest.php`
...
- [ ] T071 [P] **TEST** Listener PersistAuditLog — `tests/Feature/Fase0/Audit/AuditPersistenceTest.php`
...
- [ ] T072 Model `AuditLog` + interface `Auditable` + trait `RecordsActivity` — `app/Models/AuditLog.php`, `app/Events/Auditable.php`, `app/Models/Concerns/RecordsActivity.php`
...
- [ ] T073 Listener `PersistAuditLogListener` + binding em `EventServiceProvider` — `app/Listeners/PersistAuditLogListener.php`, `app/Providers/EventServiceProvider.php`
...
- [ ] T074 [P] Service `AuditService` — `app/Services/Audit/AuditService.php`
...
- [ ] T075 [P] Arquivos lang pt-BR base — `lang/pt_BR/auth.php`, `validation.php`, `tenant.php`, `billing.php`
...
- [ ] T076 [P] Vue I18n locale pt-BR — `resources/js/i18n/pt-BR.json`
...
- [ ] T100 [P] [US6] **TEST** Login feature happy path — `tests/Feature/Fase0/Auth/LoginTest.php`
...
- [ ] T101 [P] [US6] **TEST** Bloqueio temporário após 5 falhas — `tests/Feature/Fase0/Auth/BruteForceLockTest.php`
...
- [ ] T103 [US6] Service `AuthenticationService` + `LoginRequest` + `LoginController` + `Resource` — `app/Services/Auth/AuthenticationService.php`, `app/Http/Requests/Auth/LoginRequest.php`, `app/Http/Controllers/Api/V1/Auth/LoginController.php`, `app/Http/Resources/AuthenticatedUserResource.php`
...
- [ ] T105 [P] [US6] `LogoutController` + `MeController` — `app/Http/Controllers/Api/V1/Auth/LogoutController.php`, `app/Http/Controllers/Api/V1/Auth/MeController.php`
...
- [ ] T107 [P] [US6] Vue: `LoginPage.vue` + auth store — `resources/js/pages/auth/LoginPage.vue`, `resources/js/stores/auth.js`
...
- [ ] T108 [P] [US6] Router guards + axios interceptor — `resources/js/router/index.js`, `resources/js/lib/api.js`
...
- [ ] T120 [P] [US8] **TEST** Fluxo completo de recuperação — `tests/Feature/Fase0/Auth/PasswordResetTest.php`
...
- [ ] T121 [P] [US8] **TEST** Notificação de troca de senha — `tests/Feature/Fase0/Auth/PasswordChangedNotificationTest.php`
...
- [ ] T122 [US8] Service + Controllers de password reset — `app/Services/Auth/PasswordResetService.php`, `app/Http/Controllers/Api/V1/Auth/PasswordController.php`, `app/Http/Requests/Auth/{ForgotPasswordRequest,ResetPasswordRequest}.php`
...
- [ ] T123 [P] [US8] Vue: `ForgotPasswordPage.vue` + `ResetPasswordPage.vue` — `resources/js/pages/auth/ForgotPasswordPage.vue`, `resources/js/pages/auth/ResetPasswordPage.vue`
...
- [ ] T140 [P] [US1] **TEST** Cadastro happy path — `tests/Feature/Fase0/Tenant/RegisterTenantTest.php`
...
- [ ] T141 [P] [US1] **TEST** Validações & deduplicação — `tests/Feature/Fase0/Tenant/RegisterTenantValidationTest.php`
...
- [ ] T142 [P] [US1] **TEST** Slug único e válido — `tests/Feature/Fase0/Tenant/SlugGenerationTest.php`
...
- [ ] T143 [US1] Service `TenantRegistrationService` + Controller público + Form Request — `app/Services/Tenant/TenantRegistrationService.php`, `app/Http/Controllers/Api/V1/Tenant/RegisterController.php`, `app/Http/Requests/Tenant/RegisterTenantRequest.php`
...
- [ ] T144 [P] [US1] `TenantResource` + `CurrentTenantController` (GET /tenant) — `app/Http/Resources/TenantResource.php`, `app/Http/Controllers/Api/V1/Tenant/CurrentTenantController.php`
...
- [ ] T145 [P] [US1] Welcome notification + job — `app/Notifications/WelcomeNotification.php`, `app/Jobs/Email/SendWelcomeEmailJob.php`, `resources/views/emails/welcome.blade.php`
...
- [ ] T146 [P] [US1] Vue: `RegisterTenantPage.vue` (público) — `resources/js/pages/tenant-register/RegisterTenantPage.vue`
...
- [ ] T160 [P] [US2] **TEST** Onboarding state e progresso — `tests/Feature/Fase0/Onboarding/OnboardingWizardTest.php`
...
- [ ] T161 [US2] Coluna `onboarding_state` no Model `Tenant` — `app/Models/Tenant.php`
...
- [ ] T162 [US2] Service `OnboardingService` + Controller + Form Request + Resource — `app/Services/Onboarding/OnboardingService.php`, `app/Http/Controllers/Api/V1/Onboarding/OnboardingController.php`, `app/Http/Resources/OnboardingStateResource.php`
...
- [ ] T163 [P] [US2] Vue: `OnboardingWizardPage.vue` — `resources/js/pages/onboarding/OnboardingWizardPage.vue`
...
- [ ] T180 [P] [US3] **TEST** Idempotência de webhook — `tests/Feature/Fase0/Billing/StripeWebhookIdempotencyTest.php`
...
- [ ] T181 [P] [US3] **TEST** Checkout flow + plan attachment — `tests/Feature/Fase0/Billing/CheckoutTest.php`
...
- [ ] T182 [P] [US3] **TEST** Inadimplência D+7 → restrições — `tests/Feature/Fase0/Billing/OverdueRestrictionsTest.php`
...
- [ ] T183 [US3] Cashier wiring no Model `Tenant` (Billable) — `app/Models/Tenant.php`
...
- [ ] T184 [US3] Webhook controller + idempotência via `stripe_events` — `app/Http/Controllers/Webhooks/StripeWebhookController.php`, `app/Services/Billing/StripeWebhookService.php`
...
- [ ] T185 [US3] Service `CheckoutService` + Controller + Form Request — `app/Services/Billing/CheckoutService.php`, `app/Http/Controllers/Api/V1/Billing/CheckoutController.php`, `app/Http/Requests/Billing/CheckoutRequest.php`
...
- [ ] T186 [P] [US3] Service `SubscriptionService` + `PlansController` + `SubscriptionController` (GET) — `app/Services/Billing/SubscriptionService.php`, `app/Http/Controllers/Api/V1/Billing/PlansController.php`, `app/Http/Controllers/Api/V1/Billing/SubscriptionController.php`
...
- [ ] T187 [US3] Job + Command `ApplyOverdueRestrictionsJob` — `app/Jobs/Tenant/ApplyOverdueRestrictionsJob.php`, `app/Console/Commands/ApplyOverdueRestrictions.php`
...
- [ ] T188 [US3] Middleware `ApplyOverdueRestrictions` (gate de rotas premium) — `app/Http/Middleware/ApplyOverdueRestrictions.php`
...
- [ ] T189 [P] [US3] Notificação `PaymentFailedNotification` + job — `app/Notifications/PaymentFailedNotification.php`, `app/Jobs/Email/SendPaymentFailedEmailJob.php`, `resources/views/emails/payment-failed.blade.php`
...
- [ ] T190 [P] [US3] Vue: `PlansPage.vue` + `SubscriptionPage.vue` — `resources/js/pages/billing/PlansPage.vue`, `resources/js/pages/billing/SubscriptionPage.vue`
...
- [ ] T200 [P] [US4] **TEST** Proration em aumento de profissionais — `tests/Feature/Fase0/Billing/SubscriptionPatchTest.php`
...
- [ ] T201 [P] [US4] **TEST** Downgrade adiado para próximo ciclo — `tests/Feature/Fase0/Billing/SubscriptionDowngradeTest.php`
...
- [ ] T202 [US4] PATCH `/billing/subscription` + Form Request + Service swap — `app/Http/Controllers/Api/V1/Billing/SubscriptionController.php` (método patch), `app/Http/Requests/Billing/SubscriptionPatchRequest.php`, extensão de `SubscriptionService`
...
- [ ] T203 [P] [US4] UI inline em `SubscriptionPage.vue` — atualização de `resources/js/pages/billing/SubscriptionPage.vue`
...
- [ ] T220 [P] [US5] **TEST** AiUsageMeter open/close por ciclo — `tests/Feature/Fase0/Billing/AiUsageMeterTest.php`
...
- [ ] T221 [P] [US5] **TEST** Hard cap configurado e estado triggered — `tests/Feature/Fase0/Billing/HardCapTest.php`
...
- [ ] T222 [US5] Service `AiUsageService` + Controller GET — `app/Services/Billing/AiUsageService.php`, `app/Http/Controllers/Api/V1/Billing/AiUsageController.php`, resource `AiUsageResource`
...
- [ ] T223 [US5] Service `HardCapService` + PATCH endpoint + Form Request — `app/Services/Billing/HardCapService.php`, `app/Http/Controllers/Api/V1/Billing/AiUsageController.php` (método patchHardCap), `app/Http/Requests/Billing/HardCapRequest.php`
...
- [ ] T224 [P] [US5] Job `AlertAiUsageThresholdJob` — `app/Jobs/Billing/AlertAiUsageThresholdJob.php`
...
- [ ] T225 [P] [US5] Vue: `AiUsagePage.vue` — `resources/js/pages/billing/AiUsagePage.vue`
...
- [ ] T240 [P] [US7] **TEST** Fluxo de convite — `tests/Feature/Fase0/Users/InvitationFlowTest.php`
...
- [ ] T241 [P] [US7] **TEST** Limite de usuários do plano — `tests/Feature/Fase0/Users/UserLimitTest.php`
...
- [ ] T242 [P] [US7] **TEST** Último Admin Clínica não pode ser removido — `tests/Feature/Fase0/Users/LastAdminGuardTest.php`
...
- [ ] T243 [US7] Service `InvitationService` + Controllers + Form Requests — `app/Services/Users/InvitationService.php`, `app/Http/Controllers/Api/V1/Users/InvitationsController.php`, requests `CreateInvitationRequest` + `AcceptInvitationRequest`, notification + job, `app/Notifications/InvitationNotification.php`
...
- [ ] T244 [US7] Service `UserService` + `UsersController` (GET/PATCH/DELETE) + Policies — `app/Services/Users/UserService.php`, `app/Http/Controllers/Api/V1/Users/UsersController.php`, `app/Http/Requests/Users/UserPatchRequest.php`, `app/Policies/UserPolicy.php`, `app/Policies/InvitationPolicy.php`
...
- [ ] T245 [P] [US7] Job `PurgeExpiredInvitationsJob` agendado — `app/Jobs/Users/PurgeExpiredInvitationsJob.php`
...
- [ ] T246 [P] [US7] Vue: `UsersListPage.vue` + `InviteUserPage.vue` + `AcceptInvitationPage.vue` — `resources/js/pages/users/UsersListPage.vue`, `resources/js/pages/users/InviteUserPage.vue`, `resources/js/pages/invitations/AcceptInvitationPage.vue`
...
- [ ] T260 [P] [US9] **TEST** Listagem com filtros — `tests/Feature/Fase0/Audit/AuditLogTest.php`
...
- [ ] T261 [P] [US9] **TEST** Export CSV escapado contra injeção em planilha — `tests/Feature/Fase0/Audit/AuditLogExportCsvTest.php`
...
- [ ] T262 [US9] Controller GET + Policy + Resource — `app/Http/Controllers/Api/V1/Audit/AuditLogsController.php`, `app/Policies/AuditLogPolicy.php`, `app/Http/Resources/AuditLogResource.php`
...
- [ ] T263 [US9] Export CSV via `CsvExporter` + endpoint — `app/Support/Csv/CsvExporter.php`, método export no `AuditLogsController`
...
- [ ] T264 [P] [US9] Jobs de retenção: archive + delete — `app/Jobs/Audit/ArchiveAuditLogsJob.php`, `app/Jobs/Audit/DeleteExpiredAuditLogsJob.php`, commands artisan
...
- [ ] T265 [P] [US9] Vue: `AuditLogsPage.vue` — `resources/js/pages/audit/AuditLogsPage.vue`
...
- [ ] T280 [P] **TEST** Acesso a `/admin` restrito a super admin — `tests/Feature/Fase0/Admin/AdminPanelAccessTest.php`
...
- [ ] T281 [P] **TEST** Filament reusa Service — `tests/Feature/Fase0/Admin/FilamentReusesServicesTest.php`
...
- [ ] T282 Filament v5 setup + gate super admin — `app/Providers/Filament/AdminPanelProvider.php`
...
- [ ] T283 Service `TenantStateService` + `TenantResource` Filament — `app/Services/Tenant/TenantStateService.php`, `app/Filament/Resources/TenantResource.php`
...
- [ ] T284 [P] Service `PlanService` + `PlanResource` Filament — `app/Services/Billing/PlanService.php`, `app/Filament/Resources/PlanResource.php`
...
- [ ] T285 [P] Filament page `PlatformMetrics` + widget — `app/Filament/Pages/PlatformMetrics.php`, `app/Filament/Widgets/ActiveTenantsWidget.php`
...
- [ ] T286 [P] Impersonate auditado de Super Admin — `app/Filament/Resources/TenantResource.php` (action) + middleware
...
- [ ] T287 [P] Filament filtro/widget "Tenants elegíveis a suspensão (≥30d em overdue)" — `app/Filament/Resources/TenantResource.php` (filter) + `app/Filament/Widgets/SuspensionEligibleTenantsWidget.php`
...
- [ ] T300 [P] Validar OpenAPI vs rotas reais — `contracts/openapi.yaml`
...
- [ ] T301 [P] Documentar API com Scribe — `config/scribe.php`, output em `public/docs`
...
- [ ] T310 [P] **E2E** Cadastro → onboarding → login — `tests/e2e/tenant-register-and-onboard.spec.ts`
...
- [ ] T311 [P] **E2E** Convite e aceite — `tests/e2e/invite-and-accept.spec.ts`
...
- [ ] T312 [P] **E2E** Checkout Stripe (test mode) — `tests/e2e/checkout.spec.ts`
  - Descrição: usar `stripe trigger` ou cartão `4242 4242 4242 4242`; verificar transição de tenant `trial → active`.
  - Arquivos: o listado.
  - Aceitação: passa em CI com Stripe test keys.
  - Depende de: T185, T190
  - Princípio: IV, V

- [ ] T314 [P] **E2E** Recuperação de senha — `tests/e2e/password-reset.spec.ts`
...
- [ ] T320 Verificação final: cobertura ≥ 70% + Pint clean + tenant isolation expandido — `tests/Feature/Fase0/Tenant/TenantIsolationTest.php` (atualização)
  - Descrição: rodar `phpunit --coverage --min=70`; rodar `pint --test`; expandir `TenantIsolationTest` para cobrir 100% dos endpoints autenticados desta fase (audit, billing, users, onboarding, ai-usage).
  - Arquivos: testes existentes atualizados.
  - Aceitação: cobertura ≥ 70%; Pint sem diff; tenant isolation cobre todos os endpoints.
  - Depende de: todas as fases anteriores
  - Princípio: II, IV

- [ ] T321 [P] Atualizar quickstart.md com qualquer ajuste real — `quickstart.md`
  - Descrição: revalidar os 25 passos manuais após implementação; ajustar comandos/URLs reais.
  - Arquivos: `quickstart.md` (já criado).
  - Aceitação: novo dev consegue subir o projeto seguindo o doc.
  - Depende de: T320
  - Princípio: IV

- [ ] T322 [P] Atualizar checklist final do spec — `specs/001-fundacao-multitenant/checklists/requirements.md`
  - Descrição: marcar todos os itens como `[x]`; anotar drift se houver.
  - Arquivos: o listado.
  - Aceitação: 100% verde.
  - Depende de: T320
  - Princípio: IV
